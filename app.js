...
var colori = require('./routes/colori');
var magazzini = require('./routes/magazzino');
var categoriearticolo = require('./routes/categoriearticolo');
...
app.use('/colori', colori);
app.use('/magazzini',magazzini);
app.use('/articoli', articoli);
app.use('/categoriearticolo', categoriearticolo);
app.use('/udm', udm);
